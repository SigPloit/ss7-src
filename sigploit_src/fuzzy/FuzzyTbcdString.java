 ...
 *
 */
public abstract class FuzzyTbcdString implements MAPAsnPrimitive {
	...
	for (int i = 0; i < chars.length; i = i + 2) {
	     ...
	     * char a = chars[i];
	     * 
	     * int digit1 = encodeNumber(a); int digit2; if ((i + 1) == chars.length) { //
	     * add the filler instead digit2 = 15; } else { char b = chars[i + 1]; digit2 =
	     * encodeNumber(b); }
	     * 
