...
public class UpdateLocationServer extends FUlLowLevelServer {
	...
	try {
		...
		try {
		    ...
		    mapDialog.addUpdateLocationRequest(imsi, msc, null, msc, null, null, null, false, false, null, null,
			    null, false, false);
	...
	final UpdateLocationServer attacker = new UpdateLocationServer();
