...
public class ProvideSubscriberInformationReq extends PSILowLevel implements MAPServiceMobilityListener {
    ...
    public void onProvideSubscriberInfoResponse(ProvideSubscriberInfoResponse provideSubscriberInfoResponse) {
        try {
            ...
            int aol = provideSubscriberInfoResponse.getSubscriberInfo().getLocationInformation().getAgeOfLocationInformation();
            ...
            ISDNAddressString sgsn = provideSubscriberInfoResponse.getSubscriberInfo().getLocationInformationGPRS().getSGSNNumber();
            ...
            if(provideSubscriberInfoResponse.getSubscriberInfo().getLocationInformation().getCellGlobalIdOrServiceAreaIdOrLAI() == null){
